...
export class BaasManagementComponent implements OnInit {
  ...
  // Sample BaaS services data based on the provided text
  services: BaasService[] = [
    ...
    },
    {
      ...
      logo: "/placeholder.svg?height=60&width=120&text=Receba",
      category: "payment",
      status: "active",
      version: "v1.8.2",
      environment: "production",
    ...
    },
    {
      ...
      provider: "Transfeera",
      logo: "/placeholder.svg?height=60&width=120&text=Transfeera",
      category: "banking",
      status: "active",
      version: "v3.2.1",
      environment: "production",
